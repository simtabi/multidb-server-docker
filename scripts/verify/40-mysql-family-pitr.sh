...
# nothing about the other. DBTK_PITR_ENGINE narrows it for debugging.
for engine in ${DBTK_PITR_ENGINE:-mysql mariadb}; do
    ...
    name="dbtk-verify-mypitr-${engine}-$$"
    vol="dbtk-verify-mypitr-binlog-${engine}-$$"
